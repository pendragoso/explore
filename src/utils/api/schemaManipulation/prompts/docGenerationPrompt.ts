export const docGenerationPrompt = `Use GraphQL schema type definition provided, generate a title for the schema, detailed description for each field and an example query/mutation using variables. Make sure to have 2 additional space for each level of nesting and all fields are present.
...
- user(email: String): User
  ...
  - User: The information associated with a user
